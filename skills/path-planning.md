...
Use this skill when a learning map needs to become an executable plan.

## Purpose

Turn the map into stages, weekly focus, daily actions, and review rules.

## When To Use

- The learner approved or accepted the learning map.
- The learner asks what to do next.
- The previous plan expired, failed, or became too easy.
- Review adjustment requires a new plan.
